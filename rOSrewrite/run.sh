...
ld -m elf_i386 -T linker.ld ./COMPF/kernel.o ./COMPF/panic.o ./COMPF/boot.o ./COMPF/setup.o ./COMPF/io.o ./COMPF/kutils.o ./COMPF/ui.o ./COMPF/utils.o -o ./rOS.bin -nostdlib
