...
void KERNEL_MAIN()
{
  ...
  printString("RoverOS");
  printNewLine();
  printString("Loaded TEXT from: VGA_ADDRESS 0xB8000");
  printNewLine();
  printString("Listing directories:");
printNewLine();
printString("Root");
printNewLine();
printString("Scripts");
...
printString("boot");
printNewLine();
printString("boot.catalog");
printNewLine();
printString("efi.img");
printNewLine();
printString("mach_kernel");
printNewLine();
printString("entitlements");
  printNewLine();
printString(".");
  printNewLine();
  printString("RoverOS Finished");
}
